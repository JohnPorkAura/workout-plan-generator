"""
Workout Plan Generator — A personalised workout built for you
...
DB_FILE      = "workout_plan_generator.db"
SYSTEM_PROMPT = "You are an expert Workout Plan Generator assistant. Enter your fitness level, goals, available equipment, and time. Get a structured weekly workout plan."
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Workout Plan Generator</div>
    <div class="auth-sub">A personalised workout built for you</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Workout Plan Generator</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Workout Plan Generator</em><br>A personalised workout built for you</h1>
    <p>Enter your fitness level, goals, available equipment, and time. Get a structured weekly workout plan. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <button class="card-action" onclick="clearForm()">Clear</button>
        ...
        <div class="field">
      <label for="field-fitness_level">Fitness Level</label>
      <select id="field-fitness_level" required>
    ...
    <div class="field">
      <label for="field-goals">Goals</label>
      <select id="field-goals">
        <option value="">— Select —</option>
    ...
    <div class="field">
      <label for="field-equipment">Equipment</label>
      <input type="text" id="field-equipment" placeholder="e.g. your equipment">
    </div>
    <div class="field">
      <label for="field-days_per_week">Days Per Week</label>
      <select id="field-days_per_week">
        <option value="">— Select —</option>
  ...
  <footer>
    <div class="foot-note">Workout Plan Generator &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  inputs:         [{"id": "fitness_level", "label": "Fitness Level", "type": "select", "options": ["Beginner", "Intermediate", "Advanced"], "required": true}, {"id": "goals", "label": "Goals", "type": "select", "options": ["Make a request", "Follow up", "Decline politely", "Introduce myself", "Give feedback", "Share update"], "required": false}, {"id": "equipment", "label": "Equipment", "type": "text", "placeholder": "e.g. your equipment", "required": false}, {"id": "days_per_week", "label": "Days Per Week", "type": "select", "options": ["2", "3", "4", "5", "6"], "required": false}],
};
